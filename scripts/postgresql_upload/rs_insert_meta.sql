...
INSERT INTO dbtree VALUES( 1019, 1018, '2010', 'Projekty powiatowe EFRR 2010', NULL, 0, 0, 'data_50008', TRUE );
INSERT INTO dbtree VALUES( 1020, 1018, '2011', 'Projekty powiatowe EFRR 2011', NULL, 0, 0, 'data_50009', TRUE );
COMMIT;

------------- C O U N T E R S --------------
BEGIN;
INSERT INTO counters VALUES( 'dbtree', 1016 );
INSERT INTO counters VALUES( 'endpoints', 50009 );
...
INSERT INTO columns VALUES( '{"data_50006"}', 'rodzaj_finansowania_wydatkow', 'Rodzaj finansowania wydatków', '@', FALSE, 'string', TRUE, FALSE );
...
INSERT INTO columns VALUES( '{"data_50006"}', 'zobowiazania_wymagalne_powstale_w_latach_ubieglych', 'Zobowiązania wymagalne powstałe w latach ubiegłych', '# ##0', FALSE, 'number', TRUE, FALSE );
INSERT INTO columns VALUES( '{"data_50006"}', 'zobowiazania_wymagalne_powstale_w_roku_biezacym', 'Zobowiązania wymagalne powstałe w roku bieżącym', '# ##0', FALSE, 'number', TRUE, FALSE );
INSERT INTO columns VALUES( '{"data_50006"}', 'wydatki_ktore_nie_wygasly_z_uplywem_biezacego_roku_budzetowego', 'Wydatki które nie wygasły z upływem bieżącego roku budżetowego', '# ##0', FALSE, 'number', TRUE, FALSE );
COMMIT;
